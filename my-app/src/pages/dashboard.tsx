...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-lightCream to-brand-golden/30">
      {/* Header */}
      <header className="bg-brand-darkBlue shadow-lg border-b border-brand-darkBlue/20 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center justify-between">
              ...
              >
                <div className="bg-brand-mediumBlue rounded-lg p-2 shadow-md">
                  <Rocket className="h-6 w-6 text-white" />
                </div>
                <h1 className="text-xl font-bold text-white">FitFinder</h1>
              </Link>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-8 h-8 bg-brand-mediumBlue rounded-full flex items-center justify-center shadow-md">
          ...
          <div className="lg:col-span-1">
            <Card className="shadow-xl border-0 bg-white/95 backdrop-blur">
              <CardHeader className="bg-gradient-to-r from-brand-darkBlue to-brand-mediumBlue text-white rounded-t-lg">
                <CardTitle className="text-lg font-semibold">Upload CVs & Job Description</CardTitle>
              </CardHeader>
